...
public class ListadeCompras extends javax.swing.JFrame {
     ...
     */
    String[] tagAux;
    ListadeComprasClasse lstcmpAux;
    ...
    private void initComponents() {
        ...
        btnFoiComprado = new javax.swing.JButton();
        ...
        btnFoiComprado.setText("Foi Comprado");
        btnFoiComprado.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnFoiCompradoActionPerformed(evt);
            }
        });
            ...
            .addGroup(BackgroundLayout.createSequentialGroup()
                ...
                .addGroup(BackgroundLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(BackgroundLayout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(btnFoiComprado, javax.swing.GroupLayout.PREFERRED_SIZE, 117, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap(40, Short.MAX_VALUE))
        );
    ...
    private void btnLimparActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLimparActionPerformed
        ...
        carregarTabela(lstcmp);
    }//GEN-LAST:event_btnLimparActionPerformed

    private void btnRemoverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoverActionPerformed
        // TODO add your handling code here:
        int[] itens = lstTabela.getSelectedRows();
        for(int i = 0; i < itens.length;i++){
            lstcmp.removeItem(lstcmp.getItem(i));
        }
        if(lstcmpAux != null){
            lstcmpAux.clear();
        }
    ...
    private void btnProcurarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProcurarActionPerformed
        ...
        for(int i = 0; i < lstcmp.tamanho(); i++){
            if(lstcmp.getItem(i).getNome().contains(itemDes)){
                itensNomes.add(lstcmp.getItem(i).getNome());
            }
        }
        ...
        ArrayList<Item> ItensDes = lstcmp.filtraItem(tagDes, projetoDes,itensNomes);
        lstcmpAux = new ListadeComprasClasse(ItensDes);
        carregarTabela(lstcmpAux);
    }//GEN-LAST:event_btnProcurarActionPerformed

    private void btnFoiCompradoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFoiCompradoActionPerformed
        // TODO add your handling code here:
        int[] itens = lstTabela.getSelectedRows();
        for(int i = 0; i < itens.length;i++){
            lstcmp.foiComprado(lstcmp.getItem(i));
            est.adicionaItem(lstcmp.getItem(i));
            lstcmp.removeItem(lstcmp.getItem(i));
    ...
    }//GEN-LAST:event_btnFoiCompradoActionPerformed
    public void carregarTabela(ListadeComprasClasse lstcmp){
        DefaultTableModel modelo = new DefaultTableModel(new Object[] {"Nome","Quantidade","Projeto","Tags"},0);
       
        for(int i = 0; i < lstcmp.tamanho(); i++){
                Object linha[] = new Object[]{lstcmp.getItem(i).getNome(),lstcmp.getItem(i).getQtd(),lstcmp.getItem(i).getProjeto().getNome(),lstcmp.getItem(i).getTags()};
                modelo.addRow(linha); 
                   
        }
        lstTabela.setModel(modelo);
        
        lstTabela.getColumnModel().getColumn(0).setPreferredWidth(5);
        lstTabela.getColumnModel().getColumn(1).setPreferredWidth(50);
        lstTabela.getColumnModel().getColumn(2).setPreferredWidth(50);
        lstTabela.getColumnModel().getColumn(3).setPreferredWidth(50);
    ...
    public void atualizaBntMembro(){
        btnFoiComprado.setEnabled(false);
    }
    
    public void atualizaBntDir(){
        btnFoiComprado.setEnabled(true);
    }
    /**
    ...
    private javax.swing.JButton btnFoiComprado;
